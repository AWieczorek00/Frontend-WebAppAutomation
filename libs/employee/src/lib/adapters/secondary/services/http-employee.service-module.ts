...
import { UPDATE_EMPLOYEE_DTO_PORT } from '../../../application/ports/secondary/dto/update-employee.dto-port';
import { GET_ONE_EMPLOYEE_DTO_PORT } from '../../../application/ports/secondary/dto/get-one-employee.dto-port';

@NgModule({
  imports: [],
  declarations: [],
  providers: [HttpEmployeeService, { provide: GET_ALL_EMPLOYEE_DTO_PORT, useExisting: HttpEmployeeService }, { provide: ADD_EMPLOYEE_DTO_PORT, useExisting: HttpEmployeeService }, { provide: DELETE_EMPLOYEE_DTO_PORT, useExisting: HttpEmployeeService }, { provide: UPDATE_EMPLOYEE_DTO_PORT, useExisting: HttpEmployeeService }, { provide: GET_ONE_EMPLOYEE_DTO_PORT, useExisting: HttpEmployeeService }],
  exports: []
})
