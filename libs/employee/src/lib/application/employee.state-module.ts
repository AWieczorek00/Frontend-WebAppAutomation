...
@NgModule({
  imports: [],
  declarations: [],
  providers: [EmployeeState, { provide: LOAD_EMPLOYEES_COMMAND_PORT, useExisting: EmployeeState }, { provide: GET_CURRENCY_EMPLOYEE_LIST_QUERY_PORT, useExisting: EmployeeState }, { provide: ADD_EMPLOYEE_COMMAND_PORT, useExisting: EmployeeState }, { provide: DELETE_EMPLOYEE_COMMAND_PORT, useExisting: EmployeeState }, { provide: UPDATE_EMPLOYEE_COMMAND_PORT, useExisting: EmployeeState }],
  exports: []
})
